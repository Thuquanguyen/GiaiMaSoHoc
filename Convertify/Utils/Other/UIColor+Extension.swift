...
extension UIColor {
    ...
    convenience init(_ hex: String, alpha: CGFloat? = 1) {
        ...
        self.init(
            ...
            blue: CGFloat(b) / 0xff, alpha: alpha ?? 1
        )
    }
    ...
    convenience init(hexa: Int) {
        self.init(red:(hexa >> 16) & 0xff, green:(hexa >> 8) & 0xff, blue:hexa & 0xff)
    }
}


extension UIImage {
    #warning("Not yet import image")
    static let itemBackgroundDefaultImage = UIImage.init(named: "ic_item_background_default")
}
